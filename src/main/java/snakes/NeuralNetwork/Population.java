...
public class Population {
    ...
    public static final int ELITISM_COUNT = 8; // must be lessor equal to POPULATION_SIZE
    ...
    public static final ActivationFunction DEFAULT_ACTIVATION_FUNCTION = new ReLU();
