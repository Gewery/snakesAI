...
public class ShortestPathApple extends ShortestPath {
    /**
    ...
    public double value(Direction direction, Snake snake, Snake opponent, Coordinate mazeSize, Coordinate apple) {
        ...
        return calculateShortestPath(source, apple, movedSnake, opponent, mazeSize, apple) / calculateDiagonalDistance(mazeSize);
    }
}
